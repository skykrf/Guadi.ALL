...
namespace Guadi.Common.Tools
{
    ...
    public class OperationResult
    {
        ...
        /// <summary>
        /// 初始化一个 定义返回信息的业务操作结果信息类 的实例
        /// </summary>
        /// <param name="resultType">业务操作结果类型</param>
        /// <param name="message">业务返回消息</param>
        public OperationResult(OperationResultType resultType, string message) : this(resultType)
        {
            Message = message;
        }
        ...
        public OperationResult(OperationResultType resultType, string message, object appendData):this(resultType,message)
        {
