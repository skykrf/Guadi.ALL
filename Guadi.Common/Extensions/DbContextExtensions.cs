...
namespace Guadi.Common.Data.Extensions
{
    public static class DbContextExtensions
    {
        ...
        public static void Update<TEntity,TKey>(this DbContext dbContext, params TEntity[] entities) where TEntity : DataBase<TKey>
        {
        ...
        public static void Update<TEntity,TKey>(this DbContext dbContext,
                                           ...
                                           params TEntity[] entities)where TEntity:DataBase<TKey>
        {
